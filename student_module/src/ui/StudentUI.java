...
public class StudentUI extends JFrame {
    ...
    private JPanel tabCourses() {
        ...
        JTable tbl = tbl(mdl);
        int tot = 0;
        for (Course c : courseDAO.getCoursesBySemester(currentStudent.getCurrentSemester())) {
    ...
    private JPanel tabMaterials() {
        ...
        List<Course> courses = courseDAO.getCoursesBySemester(currentStudent.getCurrentSemester());
